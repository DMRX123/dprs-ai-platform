  ...
  return (
    <section className="relative min-h-screen flex items-center justify-center pt-16">
      <div className="relative z-10 text-center px-4 max-w-7xl mx-auto">
        <div className="inline-flex items-center gap-3 glass-card px-6 py-3 rounded-full mb-8 scroll-reveal">
        ...
        <h1 className="text-5xl md:text-7xl lg:text-8xl font-bold mb-6 scroll-reveal">
          <span className="gradient-text">DPRS</span>
          <br />
          <span className="text-white">Development Solutions</span>
        </h1>
        
        <p className="text-xl md:text-2xl text-gray-300 max-w-3xl mx-auto scroll-reveal">
          Web Development • Flutter Apps • iOS • Android • Windows • Cross-Platform Solutions
        </p>

        <div className="flex flex-wrap gap-4 justify-center mt-8 scroll-reveal">
        ...
        <div className="flex flex-col sm:flex-row gap-6 justify-center mt-12 scroll-reveal">
          <button
